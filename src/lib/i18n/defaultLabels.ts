...
export const defaultLabels: DefaultLabels = {
  ...
  RichTextEditor: {
    ...
    alignCenterOptionLabel: 'Align center',
    alignRightOptionLabel: 'Align right',
    alignJustifyOptionLabel: 'Justify',
    boldTooltip: 'Bold (B)',
    boldIconText: 'B',
    ...
    linkTooltip: 'Link',
    imageTooltip: 'Image',
    linkUrlPlaceholder: 'http://example.org',
    linkLabelPlaceholder: 'Label (optional)',
    linkLabelAriaLabel: 'Link label',
    linkApplyLabel: 'Apply',
    linkRemoveLabel: 'Remove',
    linkInvalidUrlMessage: 'Please enter a valid URL',
  },
}
