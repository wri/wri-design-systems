...
const meta = {
  ...
  argTypes: {
    ...
    defaultGaps: {
      description:
        'Space items into separate groups (CSS gap). Set item.gap to false to keep items united.',
      control: 'boolean',
    },
    autoCollapse: {
      description:
...
const ActiveItemExample = () => {
  ...
  const items = React.useMemo(
    () => [
      ...
      {
        icon: activeItem ? <LegendIcon /> : <InfoIcon />,
...
export const ExpandVerticalRight: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Vertical toolbar with `expandSide="right"`. Icons stay fixed; labels grow to the right.',
      },
    },
  },
}
...
export const ExpandVerticalLeft: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Vertical toolbar with `expandSide="left"`. Icons stay fixed; labels grow to the left.',
      },
    },
  },
}
...
export const ExpandHorizontalRight: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Horizontal toolbar with `expandSide="right"`. Buttons widen in flow from the anchored left edge.',
      },
    },
  },
}
...
export const ExpandHorizontalLeft: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Horizontal toolbar with `expandSide="left"`. Buttons widen in flow from the anchored right edge.',
      },
    },
  },
}
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      {showHeight && (
        ...
        >
          <span>
            Container height: <strong>{height}px</strong> — drag to test
            overflow
          </span>
          <input
            id={heightInputId}
...
export const AutoCollapseVerticalLeft: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Vertical `autoCollapse` with `expandSide="left"`. Overflow menu opens to the left of the ⋯ trigger.',
      },
    },
  },
}
